...
<form action="clientes_listado.php" method="GET">
...
$sql = "SELECT * 
		FROM customers 
		WHERE customerName LIKE '%" . $_GET['customerName'] . "%' AND
		city LIKE '%" . $_GET['city'] . "%' AND
		(state LIKE '%" .$_GET['state']. "%' OR state IS NULL) AND
